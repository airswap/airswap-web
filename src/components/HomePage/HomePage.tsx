...
const HomePage: FC = () => {
    ...
    const [transactionsTabOpen, setTransactionsTabOpen] = useState<boolean>(false);
    const { active: web3ProviderIsActive } = useWeb3React<Web3Provider>();
    const [showWalletList, setShowWalletList] = useState<boolean>(false);
    const [activeInformationModal, setActiveInformationModal] = useState<InformationModalType | null>(null);
